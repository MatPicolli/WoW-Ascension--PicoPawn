...
/picopawn -- show or hide the PicoPawn UI
/picopawn debug [ on | off ] -- spam debug messages to the console
/picopawn backup -- backup all of your scales to scale tags
