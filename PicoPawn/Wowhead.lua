...
-- PicoPawnWowheadScaleProviderOptions.LastAdded keeps track of the last time that we tried to automatically enable scales for this character.
if not PicoPawnWowheadScaleProviderOptions then PicoPawnWowheadScaleProviderOptions = { } end
if not PicoPawnWowheadScaleProviderOptions.LastAdded then PicoPawnWowheadScaleProviderOptions.LastAdded = 0 end

local _, Class = UnitClass("player")
if PicoPawnWowheadScaleProviderOptions.LastAdded < 1 then
...
if PicoPawnWowheadScaleProviderOptions.LastAdded < 2 then
	if Class == "WARRIOR" then
...
PicoPawnWowheadScaleProviderOptions.LastAdded = 2
