...
function PawnUI_InventoryPawnButton_Move()
	if PicoPawnCommon.ButtonPosition == PawnButtonPositionRight then
	...
	elseif PicoPawnCommon.ButtonPosition == PawnButtonPositionLeft then
		PawnUI_InventoryPawnButton:ClearAllPoints()
...
function PawnUI_AddInventoryTotalsToTooltip(Tooltip, Unit)
	if PicoPawnCommon.ShowUnenchanted or PicoPawnCommon.ShowEnchanted then
...
function PawnUI_ValuesTab_Refresh()
	...
	local Scale
	if PawnUICurrentScale ~= PawnUINoScale then Scale = PicoPawnCommon.Scales[PawnUICurrentScale] end
...
function PawnUIExportAllScales()
	...
	ScaleTags = ""
	for ScaleName in pairs(PicoPawnCommon.Scales) do
...
function PawnUIFrame_StatValueBox_OnTextChanged()
	...
	if PawnUICurrentStatIndex and
		...
		if PicoPawnCommon.Scales[PawnUICurrentScale].SmartGemSocketing then
		...
		if PicoPawnCommon.Scales[PawnUICurrentScale].SmartMetaGemSocketing then
...
function PawnUIFrame_GetCurrentScaleColor()
	local r, g, b
	if PawnUICurrentScale and PawnUICurrentScale ~= PawnUINoScale then r, g, b = VgerCore.HexToRGB(PicoPawnCommon.Scales[PawnUICurrentScale].Color) end
	if not r then
...
function PawnUIFrame_ScaleSocketOptionsList_SetSelection(Value)
	...
	if not PicoPawnCommon.Scales[PawnUICurrentScale] then return end
	if PawnUICurrentStatIndex == PawnUIStats_MetaSocketIndex then
		PicoPawnCommon.Scales[PawnUICurrentScale].SmartMetaGemSocketing = Value
	else
		PicoPawnCommon.Scales[PawnUICurrentScale].SmartGemSocketing = Value
	end
	PawnUIFrame_ScaleSocketOptionsList_UpdateSelection()
...
function PawnUIFrame_ScaleSocketOptionsList_UpdateSelection()
	...
	if (not IsReadOnly) and
		...
		if PawnUICurrentStatIndex == PawnUIStats_MetaSocketIndex then
			SmartSocketing = PicoPawnCommon.Scales[PawnUICurrentScale].SmartMetaGemSocketing
		else
			SmartSocketing = PicoPawnCommon.Scales[PawnUICurrentScale].SmartGemSocketing
		end
...
function PawnUIFrame_NormalizeValuesCheck_OnClick()
	...
	local Scale = PicoPawnCommon.Scales[PawnUICurrentScale]
...
function PawnUI_CompareItems()
	...
	local ThisScale = PicoPawnCommon.Scales[PawnUICurrentScale]
	...
	if PicoPawnCommon.ShowAsterisks ~= PawnShowAsterisksNever then
	...
	local ValueFormat = "%." .. PicoPawnCommon.Digits .. "f"
	local r, g, b = VgerCore.HexToRGB(PicoPawnCommon.Scales[PawnUICurrentScale].Color)
...
function PawnUIOptionsTabPage_OnShow()
	-- Tooltip options
	PawnUIFrame_ShowItemIDsCheck:SetChecked(PicoPawnCommon.ShowItemID)
	PawnUIFrame_ShowIconsCheck:SetChecked(PicoPawnCommon.ShowTooltipIcons)
	PawnUIFrame_ShowExtraSpaceCheck:SetChecked(PicoPawnCommon.ShowSpace)
	PawnUIFrame_AlignRightCheck:SetChecked(PicoPawnCommon.AlignNumbersRight)
	PawnUIFrame_AsterisksList_UpdateSelection()
	
	-- Calculation options
	PawnUIFrame_DigitsBox:SetText(PicoPawnCommon.Digits)
	PawnUIFrame_UnenchantedValuesCheck:SetChecked(PicoPawnCommon.ShowUnenchanted)
	PawnUIFrame_EnchantedValuesCheck:SetChecked(PicoPawnCommon.ShowEnchanted)
	PawnUIFrame_DebugCheck:SetChecked(PicoPawnCommon.Debug)
...
function PawnUIFrame_ShowItemIDsCheck_OnClick()
	PicoPawnCommon.ShowItemID = PawnUIFrame_ShowItemIDsCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_ShowIconsCheck_OnClick()
	PicoPawnCommon.ShowTooltipIcons = PawnUIFrame_ShowIconsCheck:GetChecked() ~= nil
	PawnToggleTooltipIcons()
end

function PawnUIFrame_ShowExtraSpaceCheck_OnClick()
	PicoPawnCommon.ShowSpace = PawnUIFrame_ShowExtraSpaceCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_AlignRightCheck_OnClick()
	PicoPawnCommon.AlignNumbersRight = PawnUIFrame_AlignRightCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_AsterisksList_SetSelection(Value)
	PicoPawnCommon.ShowAsterisks = Value
	PawnUIFrame_AsterisksList_UpdateSelection()
	PawnResetTooltips()
end

function PawnUIFrame_AsterisksList_UpdateSelection()
	PawnUIFrame_AsterisksAutoRadio:SetChecked(PicoPawnCommon.ShowAsterisks == PawnShowAsterisksNonzero)
	PawnUIFrame_AsterisksAutoNoTextRadio:SetChecked(PicoPawnCommon.ShowAsterisks == PawnShowAsterisksNonzeroNoText)
	PawnUIFrame_AsterisksOffRadio:SetChecked(PicoPawnCommon.ShowAsterisks == PawnShowAsterisksNever)
end
...
function PawnUIFrame_DigitsBox_OnTextChanged()
	...
	PicoPawnCommon.Digits = Digits
	PawnRecreateAnnotationFormats()
	PawnResetTooltips()
end

function PawnUIFrame_UnenchantedValuesCheck_OnClick()
	PicoPawnCommon.ShowUnenchanted = PawnUIFrame_UnenchantedValuesCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_EnchantedValuesCheck_OnClick()
	PicoPawnCommon.ShowEnchanted = PawnUIFrame_EnchantedValuesCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_DebugCheck_OnClick()
	PicoPawnCommon.Debug = PawnUIFrame_DebugCheck:GetChecked() ~= nil
	PawnResetTooltips()
end

function PawnUIFrame_ButtonPositionList_SetSelection(Value)
	PicoPawnCommon.ButtonPosition = Value
	PawnUIFrame_ButtonPositionList_UpdateSelection()
	PawnUI_InventoryPawnButton_Move()
end

function PawnUIFrame_ButtonPositionList_UpdateSelection()
	PawnUIFrame_ButtonRightRadio:SetChecked(PicoPawnCommon.ButtonPosition == PawnButtonPositionRight)
	PawnUIFrame_ButtonLeftRadio:SetChecked(PicoPawnCommon.ButtonPosition == PawnButtonPositionLeft)
	PawnUIFrame_ButtonOffRadio:SetChecked(PicoPawnCommon.ButtonPosition == PawnButtonPositionHidden)
end
...
function PawnUIAboutTabPage_OnShow()
	local Version = GetAddOnMetadata("PicoPawn", "Version")
	if Version then 
...
function PawnInterfaceOptionsFrame_OnLoad()
	-- NOTE: If you need anything from PicoPawnCommon in the future, you should call PawnInitializeOptions first.
...
function PawnUI_EnsureLoaded()
	if not PawnUIOpenedYet then
		...
		if not PicoPawnCommon then
			VgerCore.Fail("Pawn UI OnShow handler was called before PicoPawnCommon was initialized.")
			PawnUISwitchToTab(PawnUIHelpTabPage)
		elseif not PicoPawnCommon.ShownGettingStarted then
			PicoPawnCommon.ShownGettingStarted = true
			PawnUISwitchToTab(PawnUIHelpTabPage)
		else
			PawnUISwitchToTab(PawnUIValuesTabPage)
		end
